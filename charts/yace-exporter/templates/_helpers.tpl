...
{{ include "yace-exporter.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "yace-exporter.selectorLabels" -}}
...
*/}}
{{- define "yace-exporter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "yace-exporter.fullname" .) .Values.serviceAccount.name }}
{{- else }}
